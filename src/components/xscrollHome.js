...
const initiativeFeatures = [
  ...
  },
  {
    ...
    description:
      "How can we use AI to construct a virtual laboratory that simulates policy outcomes for S&T innovation and competitiveness?",
    image_url: Policy,
    link: "/initiatives",
  },
  {
