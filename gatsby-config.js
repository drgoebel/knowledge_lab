  ...
  plugins: [
    {
      ...
      options: {
        spaceId: process.env.CONTENTFUL_SPACE_ID, // Use environment variables
        accessToken: process.env.CONTENTFUL_ACCESS_TOKEN, // Use environment variables
      },
    },
    `gatsby-plugin-image`,
    {
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        ...
        // theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/klab-icon.png`, // This path is relative to the root of the site.
      },
    },
    {
